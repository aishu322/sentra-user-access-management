...
export function mapDashboard(
    ...
    return {
        ...
        subtitle: "Overview of your User Access Management platform.",
        ...
        stats: [
            ...
            {
                label: "Permissions",
                value: api.statistics.total_permissions.toString(),
                accent: "purple",
            },

            {
                label: "Audit Logs",
                value: api.statistics.total_audit_logs.toString(),
                accent: "orange",
            },
        ],
